package dudblockman.miad.client.gui;

import java.io.IOException;

import dudblockman.miad.common.gui.ContainerWorkbench;
...
public class GuiWorkbench extends GuiContainer implements IRecipeShownListener {
	...
	public GuiWorkbench(InventoryPlayer playerInv, World worldIn, EntityEquipmentSlot slot, ItemStack item) {
		super(new ContainerWorkbench(playerInv, worldIn, slot, item));
